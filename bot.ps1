...
$SmartReplies = @(
    ...
    @{
        patterns = @("ئەرکت چییە", "ئەرکت چێیە", "ئیشت چییە", "تایبەتمەندیت چییە", "تایبەتمەندییەکانت", "چیت پێ دەکرێت", "چ کارێک دەزانیت", "چ زیادکراوێکت هەیە", "چی دەزانیت", "چیت لە دەست دێت", "چۆن گروپ ئاوەدان دەکەیتەوە", "ئەرکەکانت")
        replies  = @("سڵاو لە تۆی گوڵ و خۆشەویست! 🌸 من ناوم گاردنیایە 🤖✨`nخزمەتکاری دڵسۆزی ئێوە و ئەم گروپەم، بەم شێوازانە گروپەکەتان ئاوەدان و پارێزراو دەکەمەوە:`n`n🎮 یاری و مەتەڵی بەکۆمەڵ (/game1 تا /game4) بە ژیری دەستکردی بێکۆتایی`n🛡️ پاراستنی پێشکەوتوو بە Gemini و سڕینەوەی وێنە و ستیکەری نەشیاو، لینک و جنێو`n🌸 بەخێرهاتنی تایبەتی ئەندامان بە پڕۆفایلی خۆیان`n📢 ئیجباری جۆینی چەناڵ (/setchannel)`n✨ وتەی ماناداری کاتژمێرە یەکسانەکان بە سیستەمی ۱۲ کاتژمێری (١٢ شەو تا ١٢ نیوەڕۆ و ١ تا ١٢ شەو)`n🔒 قوفڵکردنی گروپ (/lock)`n🤖 چات و وەڵامدانەوەی زیرەکانە بە زمانی شیرینی کوردی! 🥰✨")
    }
)
...
$BadPhrasesList = @(
    ...
    'شەڕەفت\s*بگێم', 'نامووست\s*بگێم', 'کێرم\s*بە',
