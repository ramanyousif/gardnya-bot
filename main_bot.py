...
8. LATIN SCRIPT & KURDISH LATIN (تێگەیشتن لە کوردیی لاتینی):
   ...
   - You must understand them completely, be smart and friendly, and answer them naturally in beautiful Sorani Kurdish (ئەلفوبێی کوردی).
   - NEVER say you don't understand Latin; always understand their Latin text and chat with them warmly in Sorani Kurdish!
"""
...
SMART_REPLIES = [
    ...
    },
    {
        ...
        "replies": [
            ...
            "✨ <b>کاتژمێرە یەکسانەکان:</b> لە کاتژمێرە جوانەکانی سیستەمی ۱۲ کاتژمێری (وەک 11:11 و 12:12 و 01:01) وتەی جوان و بەنرخی Gemini پەخش دەکەم.\n"
...
MIRROR_HOURS_CONFIG = {
    # 🌙 خولی یەکەم: ١٢ی شەو تا ١٢ی نیوەڕۆ (سیستەمی ۱۲ کاتژمێری)
    ...
    "18:06": {"time_label": "06:06 (ئێوارە 🌇)", "quote": "ئێوارەتان باش و خوانتان پڕ لە بەرەکەت و ژیانتان پڕ لە کامەرانی 🌇✨💐"},
...
PRAYER_ZIKRS = {
    "fajr": [
        ...
        "«اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلًا مُتَقَبَّلًا» - خوایە بەیانییەکی پڕ بەرەکەت بە هەمووان ببەخشیت ☕🌺",
        "«اللَّهُمَّ بِكَ أَصْبَحْنَا، وَبِكَ أَمْسَيْنَا، وَبِكَ نَحْيَا، وَبِكَ نَمُوتُ، وَإِلَيْكَ النُّشُورُ» ☀️✨",
        "«يَا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغِيثُ، أَصْلِحْ لِي شَأْنِي كُلَّهُ، وَلَا تَكِلْنِي إِلَى نَفْسِي طَرْفَةَ عَيْنٍ» 🤲🤍"
    ],
    "morning": [
        "«سُبْحَانَ اللَّهِ وَبِحَمْدِهِ: عَدَدَ خَلْقِهِ، وَرِضَا نَفْسِهِ، وَزِنَةَ عَرْشِهِ، وَمِدَادَ كَلِمَاتِهِ» (٣ جار) 📿✨",
        "«حَسْبِيَ اللَّهُ لَا إِلَهَ إِلَّا هُوَ عَلَيْهِ تَوَكَّلْتُ وَهُوَ رَبُّ الْعَرْشِ الْعَظِيمِ» (٧ جار) ☀️🕊️",
        "«بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلَا فِي السَّمَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ» 🛡️🌸",
        "«رَضِيتُ بِاللَّهِ رَبًّا، وَبِالْإِسْلَامِ دِينًا، وَبِمُحَمَّدٍ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ نَبِيًّا» 🌺✨",
        "«اللَّهُمَّ عَافِنِي فِي بَدَنِي، اللَّهُمَّ عَافِنِي فِي سَمْعِي، اللَّهُمَّ عَافِنِي فِي بَصَرِي، لَا إِلَهَ إِلَّا أَنْتَ» 🤲💖"
    ],
    "dhuhr": [
        "«سُبْحَانَ اللَّهِ وَبِحَمْدِهِ، سُبْحَانَ اللَّهِ الْعَظِيمِ» - خوایە نوێژ و کردەوە چاکەکانمان لێ قبوڵ بکەیت 🌸🕋",
        "«رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ» 🤲✨",
        "«اللَّهُمَّ أَعِنِّي عَلَى ذِكْرِكَ، وَشُكْرِكَ، وَحُسْنِ عِبَادَتِكَ» 📿🌸",
        "«لَا إِلَهَ إِلَّا اللَّهُ الْعَظِيمُ الْحَلِيمُ، لَا إِلَهَ إِلَّا اللَّهُ رَبُّ الْعَرْشِ الْعَظِيمِ» 🕊️✨",
    ...
    "asr": [
        ...
        "«سُبْحَانَ اللَّهِ، وَالْحَمْدُ لِلَّهِ، وَلَا إِلَهَ إِلَّا اللَّهُ، وَاللَّهُ أَكْبَرُ» 📿🕊️",
        "«اللَّهُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ فِي دِينِي وَدُنْيَايَ وَأَهْلِي وَمَالِي» 🤲✨",
        "«لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ الْعَلِيِّ الْعَظِيمِ» - خوایە دڵەکانمان ئاوەدان بکەیت بە زیکری خۆت 🌸💖"
    ],
    "evening": [
        "«أَمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ، لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ» 🌇✨",
        "«أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ» (٣ جار) 🛡️🌙",
    ...
    "maghrib": [
        "«اللَّهُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ فِي الدُّنْيَا وَالْآخِرَةِ» - خودا دوعا و نزاکانتان گیرابکات 🤲🌇",
        "«اللَّهُمَّ هَذَا إِقْبَالُ لَيْلِكَ، وَإِدْبَارُ نَهَارِكَ، وَأَصْوَاتُ دُعَاتِكَ، فَاغْفِرْ لِي» 🤲🌆",
        "«رَضِيتُ بِاللَّهِ رَبًّا، وَبِالْإِسْلَامِ دِينًا، وَبِمُحَمَّدٍ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ نَبِيًّا» 🌙🤍",
        "«سُبْحَانَ اللَّهِ وَبِحَمْدِهِ» (١٠٠ جار) - گوناهەکان دەسڕێتەوە و دڵ ئارام دەکات 📿✨",
    ...
    "sleep": [
        ...
        "«بِاسْمِكَ اللَّهُمَّ أَمُوتُ وَأَحْيَا» - شەوێکی ئارام و خەوێکی پڕ لە ئاسوودەیی بۆ هەمووان 🌙✨🌸",
        "«قُلْ هُوَ اللَّهُ أَحَدٌ» + «قُلْ أَعُوذُ بِرَبِّ الْفَلَقِ» + «قُلْ أَعُوذُ بِرَبِّ النَّاسِ» 📖🛡️",
        "«آيَةُ الْكُرْسِيِّ»: «اللَّهُ لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ...» - پارێزەری شەوانە لە هەموو شەڕێک 🌌✨",
    ...
    "general": [
        ...
        "«لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ الْعَلِيِّ الْعَظِيمِ» 🕊️✨",
...
def get_daily_prayer_zikr(prayer_type: str) -> str:
    """هەڵبژاردنی زیکرێکی نوێ و جیاواز لە هەر جارێکدا بەبێ دووبارەبوونەوە"""
    zikr_pool = PRAYER_ZIKRS.get(prayer_type, PRAYER_ZIKRS["general"])
    history = state_data.setdefault("used_zikrs", {})
    used_list = history.setdefault(prayer_type, [])
    
    available = [z for z in zikr_pool if z not in used_list]
    if not available:
        used_list.clear()
        available = zikr_pool
...
- If the user writes in Latin script (Kurdish in Latin alphabet like 'choni', 'to key', 'swpas', etc.), understand what they mean perfectly and reply naturally and warmly in Sorani Kurdish.
...
def handle_command(msg: dict, text: str):
    ...
    if cmd in ["/start", "/setup"]:
        ...
        state_data["owner_id"] = target_uid
        save_state()
        send_message(chat_id, f"👑 <b>{display_name} گیان!</b> ئایدی <code>{target_uid}</code> بە سەرکەوتوویی وەک ئۆنەری فەرمی بۆت دیاریکرا.\n\nلە ئێستاوە هەر کەسێک لە شەخسی (PV) نامە بنێرێت، دەستبەجێ خودی پەیامەکە و ڕاپۆرتەکەی بۆ ئەو ئایدییە فۆروارد دەکرێت! 🌸✨🥰", msg_id, thread_id)
        return
    elif cmd in ["/reply", "/send", "/answer", "/dm"]:
        owner_id = state_data.get("owner_id") or config.get("ownerId")
        if not is_admin(chat_id, user_id) and user_id != owner_id:
            send_message(chat_id, "⚠️ ئەم فەرمانە تەنها بۆ بەڕێوەبەری بۆتە! 🌸", msg_id, thread_id)
            return
        parts = arg.strip().split(maxsplit=1)
        if len(parts) < 2 or not parts[0].isdigit():
            send_message(chat_id, "⚠️ شێوازی بەکارهێنان: <code>/reply &lt;user_id&gt; &lt;پەیام&gt;</code>\nنموونە: <code>/reply 123456789 سڵاو بەڕێزم فەرموو</code> 🌸", msg_id, thread_id)
            return
        target_uid = int(parts[0])
        reply_txt = parts[1]
        deliv = send_message(target_uid, f"📩 <b>پەیامێک لەلایەن بەڕێوەبەری بۆتەوە:</b>\n\n{html.escape(reply_txt)}")
        if deliv and deliv.get("ok"):
            send_message(chat_id, f"✅ پەیامەکەت بە سەرکەوتوویی بۆ بەکارهێنەر (<code>{target_uid}</code>) نێردرا! 🌸", msg_id, thread_id)
        else:
            send_message(chat_id, "❌ نەتوانرا پەیامەکە بنێردرێت؛ ڕەنگە بەکارهێنەر بۆتی بلۆک کردبێت یان چاتی دەستپێنەکردبێت.", msg_id, thread_id)
        return
    elif cmd in ["/tagall", "/calltag", "/tag", "/all", "@all"]:
        tag_all_members_batches(chat_id, arg, thread_id)
        return
    elif cmd in ["/zikr", "/zekr", "/azkar", "/adkar", "/dua"]:
        random_zikr = get_daily_prayer_zikr("general")
        z_msg = (
            "📿 <b>زیکر و نزای پیرۆز:</b> 🌸\n"
            "━━━━━━━━━━━━━━━━━━\n"
            f"{random_zikr}\n\n"
            "✨ <i>«أَلَا بِذِكْرِ اللَّهِ تَطْمَئِنُّ الْقُلُوبُ»</i> 🤲"
        )
        send_message(chat_id, z_msg, msg_id, thread_id)
        return
    elif cmd in ["/bang", "/prayer", "/salat", "/namaz"]:
        bang_txt = (
        ...
        send_message(chat_id, bang_txt, msg_id, thread_id)
        return
    elif cmd == "/rules":
        c_key = str(chat_id)
...
def forward_pv_to_owner(sender_user: dict, user_text: str, bot_reply: str = "", msg_id: int = 0, from_chat_id: int = 0):
    ...
    user_mention = f'<a href="tg://user?id={s_id}">{s_name}</a>'
    
    # ئەگەر خودی ئۆنەر قسە لەگەڵ بۆت بکات، پەیامەکەی بۆ خۆی نانێرێتەوە
    if s_id == owner_id:
        return

    # ۱. فۆرواردکردنی خودی پەیامەکە (تێکست، وێنە، دەنگ، ستیکەر، ڤیدیۆ) بۆ ئۆنەر
    if msg_id and from_chat_id:
        try:
            ...
            print(f"Forward message error: {fwd_err}")
        
    # ۲. ناردنی کارتی زانیاریی بەکارهێنەر لەگەڵ دەق و وەڵامی AI
    report = (
        "📩 <b>پەیامێکی نوێ لە چاتی شەخسی (PV) گەیشت:</b>\n"
        "━━━━━━━━━━━━━━━━━━\n"
        f"👤 <b>نێرەر:</b> {user_mention}\n"
    ...
    if bot_reply:
        report += f"\n🤖 <b>وەڵامی دراوە لەلایەن بۆت:</b>\n{html.escape(bot_reply)}\n"
    
    report += "\n💡 <i>بۆ وەڵامدانەوەی ئەم بەکارهێنەرە، ڕیپڵای (Reply)ی ئەم پەیامە بکە یان بنووسە:</i>\n"
    report += f"<code>/reply {s_id} پەیامەکەت</code>"
...
def handle_message(msg: dict):
    ...
    if chat_type == "private":
        owner_id = state_data.get("owner_id") or config.get("ownerId")
        # ئەگەر خودی ئۆنەر وەڵامی ڕاپۆرتێکی فۆرواردکراوی دابێتەوە (Reply)
        if owner_id and user_id == owner_id and "reply_to_message" in msg and text:
            replied_msg = msg.get("reply_to_message", {})
            rep_text = replied_msg.get("text", "")
            id_match = re.search(r"🆔\s*<b>ئایدی:</b>\s*<code>(\d+)</code>", rep_text)
            if id_match:
                target_uid = int(id_match.group(1))
                deliv = send_message(target_uid, f"📩 <b>پەیامێک لەلایەن بەڕێوەبەری بۆتەوە:</b>\n\n{html.escape(text)}")
                if deliv and deliv.get("ok"):
                    send_message(chat_id, f"✅ پەیامەکەت بە سەرکەوتوویی بۆ بەکارهێنەر (<code>{target_uid}</code>) نێردرا! 🌸", msg_id)
                else:
                    send_message(chat_id, "❌ نەتوانرا پەیامەکە بنێردرێت؛ ڕەنگە بەکارهێنەر بۆتی بلۆک کردبێت یان چاتی دەستپێنەکردبێت.", msg_id)
                return
        ...
        # ناردنی کۆپیی تەواوی پەیامەکە (چ دەق بێت، چ وێنە، دەنگ، ستیکەر، ڤیدیۆ) بۆ ئۆنەری بۆت
        forward_pv_to_owner(from_user, text, reply, msg_id, chat_id)
        return
